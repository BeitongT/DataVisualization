...
//create svg
	var svg = d3.select("#added_surround_box")
			 .append("svg")
		     .attr("class","svg6")
		     .attr("width",svgWidth)
    ...
    var text = d3.select("#added_surround_box")
    			 .append("p")
    			 .append("center")
    			 .append("text")
    			 .text("added_surround_box")
...
//create rect
	...
	thisrect.attr("style","outline: "+ thisrect.attr("height")/2 +"px solid red;outline-offset: " + thisrect.attr("height") + "px;");
...
function myFunction() {
	...
	d3.select(".svg6").attr("width",svgWidth)
				  	  .attr("height",svgHeight);

	d3.select(".view6").attr('transform', 'translate(' + svgWidth / 2 + ',' + svgHeight / 2 + ')');
